...
function MultipleBookingEdit_GET(Web $w) {
    ...
    $w->out(Html::box('/parkmanager/MultipleBookingEdit?Test=1', "test", true));
    ...
    $post_url = '/parkmanager/MultipleBookingEdit';
...
function MultipleBookingEdit_POST(Web $w) {
    ...
    $Booking->totalcost = $_POST['rate'] * $Difference->format("%d");
