...
<div class="row-fluid clearfix small-12 multicolform"><div class="panel clearfix" id="guestpanel"><div class="row-fluid clearfix section-header"><h4>Details For Guest<span style="display: none;" class="changed_status right alert radius label">changed</span></h4></div>
...
<div class="panel clearfix"><div class="row-fluid clearfix section-header"><h4>Booking Time<span style="display: none;" class="changed_status right alert radius label">changed</span></h4></div><ul class="small-block-grid-1 medium-block-grid-2 section-body"><li><label class="small-12 columns">Start Of Stay <small>Required</small><input name="dt_startofstaydate" required="" type="date" class="small-12 columns" id="dt_startofstaydate"></label></li><li><label class="small-12 columns">End Of Stay <small>Required</small><input name="dt_endofstaydate" required="" type="date" class="small-12 columns" id="dt_endofstaydate"></label></li></ul>
</div>
