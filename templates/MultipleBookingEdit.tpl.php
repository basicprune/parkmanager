...
<div class="row-fluid clearfix small-12 multicolform"><div class="panel clearfix" id="guestpanel"><div class="row-fluid clearfix section-header"><h4>Main Contact Details<span style="display: none;" class="changed_status right alert radius label">changed</span></h4></div>
...
function addGuestFields() {
    if (hasRun == false){
        ...
        sectionHeader.id = "gustpanel" + numOfGuests;

        var heading = document.createElement("h4");
        heading.textContent = "Other Contact Details";

       
        var statusSpan = document.createElement("span");
        statusSpan.className = "changed_status right alert radius label";
        statusSpan.style.display = "none"; // Initially hidden
        statusSpan.textContent = "changed";

        heading.appendChild(statusSpan);
        sectionHeader.appendChild(heading);

        var appendme = document.getElementById("guestpanel");
        
        appendme.append(sectionHeader);

        var guestPanel = document.getElementById("guestpanel" + numOfGuests);
    ...
    var ContactForm = '<ul class="small-block-grid-1 medium-block-grid-2 section-body"><li><label class="small-12 columns">First Name<input type="text" name="';
    ContactForm += 'firstname' + numOfGuests + '" id="';
    ContactForm += 'firstname' + numOfGuests;
    
    ContactForm += '" placeholder="Enter your first name" style="width: 100%;"><div data-lastpass-icon-root="" style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;"></div></label></li><li><label class="small-12 columns">Last Name<input type="text" name="';
    
    ContactForm += 'lastname' + numOfGuests + '" id="';
    ContactForm += 'lastname' + numOfGuests + '"';
    ContactForm += 'placeholder="Enter your last name" style="width: 100%;"></label></li></ul><ul class="small-block-grid-1 medium-block-grid-2 section-body"><li><label class="small-12 columns">Mobile<input type="text" name="';
    
    ContactForm += 'mobile' + numOfGuests + '" id="';
    ContactForm += 'mobile' + numOfGuests + '"';
    ContactForm += 'placeholder="Enter your mobile number" style="width: 100%;"></label></li><li><label class="small-12 columns">Email<input type="text" name="';
    
    ContactForm += 'email' + numOfGuests + '" id="';
    ContactForm += 'email' + numOfGuests + '"';
    ContactForm += 'placeholder="Enter your email" style="width: 100%;"></label></li></ul>';

    guestPanel.innerHTML += ContactForm;
    numOfGuests++;
}
